...
def deployment_trigger(accuracy: float, config: DeploymentTriggerConfig) -> bool:
    """
    Trigger deployment only if accuracy is greater then the min_accuracy

    Args:
        accuracy: accuracy of the model
        config: mininum accuracy threshold
    Returns:
        boolean
    """
    try:
        ...
        logging.error(f"Error in deployment Trigger: {e}")
        raise e
...
def prediction_service_loader(
    ...
    print(f"##############Existing Service: {existing_services}")
